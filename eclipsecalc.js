...
let Eclipse = function(p) {
  ...
  let umCircColor, penColor;
	...
	p.preload = function() {
		...
		// the font
		LatoReg = p.loadFont('Lato-Regular.ttf');
		LatoBold = p.loadFont('Lato-Bold.ttf');

		// the texture materials, providing surfaces and night shade
		dayNight = p.loadImage('day-night.png');
		worldWrap = p.loadImage('world-wrap.png');
		MoonWrap = p.loadImage('moon-wrap-mono.png');
	};
	...
	p.setup = function() {
		...
		posCamHeightCalc = p.createSlider(-70, 70, -60, 0.25);
